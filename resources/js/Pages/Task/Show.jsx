            ...
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <div className="grid gap-1 grid-cols-2 mt-2">
                <div>
                  {/* Task ID Field */}
                  <div className="mt-4">
                    <label htmlFor="" className="font-bold text-lg">Task ID</label>
                    <p className="mt-1">{task.id}</p>
                  </div>
                  {/* Task Name Field */}
                  <div className="mt-4">
                    <label htmlFor="" className="font-bold text-lg">Task Name</label>
                    <p className="mt-1">{task.name}</p>
                  </div>
                  {/* Task Status Field */}
                  <div className="mt-4">
                    <label htmlFor="" className="font-bold text-lg">Task Status</label>
                    <p className="mt-1">
                      <span className={
                  ...
                  {/* Task Priority Field */}
                  <div className="mt-4">
                    <label htmlFor="" className="font-bold text-lg">Task Priority</label>
                    <p className="mt-1">
                      <span className={
              ...
              <div className="mt-4">
                <label htmlFor="" className="font-bold text-lg">Task Description</label>
