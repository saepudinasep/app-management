          ...
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <div className="grid gap-1 grid-cols-2 mt-2">
                <div>
                  <div className="mt-4">
                    <label htmlFor="" className="font-bold text-lg">User ID</label>
                    <p className="mt-1">{user.id}</p>
                  </div>
                  <div className="mt-4">
                    <label htmlFor="" className="font-bold text-lg">User Name</label>
                    <p className="mt-1">{user.name}</p>
                  </div>
                  <div className="mt-4">
                    <label htmlFor="" className="font-bold text-lg">User Status</label>
                    <p className="mt-1">
                      <span className={
              ...
              <div className="mt-4">
                <label htmlFor="" className="font-bold text-lg">User Description</label>
